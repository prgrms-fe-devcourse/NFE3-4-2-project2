    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-4xl font-semibold text-neutral-800 mb-2">영랑호</h2>
          <p className="text-xl font-normal text-neutral-800">자연경관지 · 호수</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="w-[720px] h-[420px] mx-auto">
              <Image src="/images/lake.png" alt="Lake" width={720} height={420} className="rounded-lg" />
            </div>
          </div>
          <div className="flex flex-col justify-between space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <Image src="/images/address.png" alt="주소" width={20} height={20} />
                <h3 className="text-xl font-semibold text-neutral-800">주소</h3>
                <p className="text-xl font-normal text-neutral-800">강원특별자치도 속초시 영랑호반길 140</p>
              </div>
              <div className="flex items-center space-x-2">
                <Image src="/images/tel.png" alt="문의처" width={20} height={20} />
                <h3 className="text-xl font-semibold text-neutral-800">문의처</h3>
                <p className="text-xl font-normal text-neutral-800">033-639-2690</p>
              </div>
              <div className="flex items-center space-x-2">
                <Image src="/images/homepage.png" alt="홈페이지" width={20} height={20} />
                <h3 className="text-xl font-semibold text-neutral-800">홈페이지</h3>
                <a
              ...
              <div className="flex items-center space-x-2">
                <Image src="/images/Facility.png" alt="편의시설" width={20} height={20} />
                <h3 className="text-xl font-semibold text-neutral-800">편의시설</h3>
                
                <Image src="/images/parking.png" alt="주차" width={20} height={20} />
                <p className="text-xl font-normal text-neutral-800">주차</p>
                
                <Image src="/images/rest_man.png" alt="남자 화장실" width={16} height={16} />
                <Image src="/images/rest_wo.png" alt="여자 화장실" width={16} height={16} />
        ...
        <section className="my-8">
          ...
          <ul className="space-y-2 text-gray-600">
            <li className="flex items-center space-x-2">
              <Image src="/images/break.png" alt="휴일" width={20} height={20} />
              <span>휴일: 연중무휴</span>
            </li>
            <li className="flex items-center space-x-2">
              <Image src="/images/time.png" alt="운영시간" width={20} height={20} />
              <span>운영시간: 07:00-20:00</span>
            </li>
            <li className="flex items-center space-x-2">
              <Image src="/images/cost.png" alt="입장료" width={20} height={20} />
              <span>입장료: 무료</span>
            </li>
          </ul>
        </section>
