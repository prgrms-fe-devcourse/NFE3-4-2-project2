               ...
               <div className="flex justify-between items-center mb-[145px]">
                  {[
                     ...
                     <div key={alt} className="flex flex-col items-center">
                        <button
                           className="w-[200px] h-[200px] rounded-full overflow-hidden focus:outline-none flex items-center justify-center bg-neutral-100 hover:bg-sky-100 hover:scale-105 hover:shadow-md"
                           onClick={onClick}>
